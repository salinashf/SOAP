...
public class WSHeaderOut implements KvmSerializable {
    ...
    public WSHeaderOut(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
	...
	public String toString() {
		return "WSHeaderOut [dispositivo=" + dispositivo + ", canal=" + canal
				+ ", medio=" + medio + ", aplicacion=" + aplicacion
